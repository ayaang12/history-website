...
export default function Leaders() {
  return (
    <section className="min-h-screen" id="leaders">
      ...
      <div className="mt-16 groovy-card p-8">
  <h2 className="section-headline text-4xl text-brown mb-4">
    Primary Source
  </h2>

  <p className="font-body text-brown/80 leading-loose">
    <strong>Mario Savio – Sproul Hall Speech (1964)</strong>
  </p>

  <blockquote className="italic border-l-4 border-sage pl-4 mt-4 text-brown/70">
    “There is a time when the operation of the machine becomes so odious…
    you've got to put your bodies upon the gears.”
  </blockquote>

  <p className="mt-5 text-brown/80 leading-loose">
    This speech became one of the most important primary sources of the
    Youth/Counterculture Movement because it expressed student frustration
    with authority, bureaucracy, and limits on free expression. It symbolized
    student activism and inspired campus protest movements throughout the 1960s.
  </p>
</div>
    </section>
  );
